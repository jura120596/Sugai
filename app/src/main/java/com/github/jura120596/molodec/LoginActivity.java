...
import com.github.jura120596.molodec.ui.signup.SignUpActivity;
        ...
        getProfileData.enqueue(new Callback<ObjectResponse<User>>() {
            ...
            public void onResponse(Call<ObjectResponse<User>> call, Response<ObjectResponse<User>> response) {
                if (response.isSuccessful()) {
                    ...
                    startActivity(new Intent(getApplicationContext(), com.github.jura120596.molodec.MainActivity.class));
                }
                button.setEnabled(true);
                finishRequest();
            }
